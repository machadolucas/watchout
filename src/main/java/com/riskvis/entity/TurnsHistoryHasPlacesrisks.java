...
/**
 * TurnsHistoryHasPlacesrisks generated by hbm2java
 */
@Entity
@Table(name = "turns_history_has_placesrisks", catalog = "test")
public class TurnsHistoryHasPlacesrisks extends AbstractEntity implements
		java.io.Serializable {

	private static final long serialVersionUID = 3532147434214916033L;
	private TurnsHistoryHasPlacesrisksId id;
	private Placesrisks placesrisks;
	private TurnsHistory turnsHistory;

	public TurnsHistoryHasPlacesrisks() {
	}

	public TurnsHistoryHasPlacesrisks(TurnsHistoryHasPlacesrisksId id,
			Placesrisks placesrisks, TurnsHistory turnsHistory) {
		this.id = id;
	...
	public void setId(TurnsHistoryHasPlacesrisksId id) {
		this.id = id;
	}
